	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "a",
	            { className: "waves-effect waves-light btn-large orange accent-4", id: "githubBtn", href: "//github.com/fractal-mind", target: "_blank" },
	            "github"
	          ),
	          _react2.default.createElement(
	            "a",
	            { className: "waves-effect waves-light btn-large orange accent-4", id: "twitterBtn", href: "//twitter.com/iamwillmoody", target: "_blank" },
	            "twitter"
	          ),
	          _react2.default.createElement(
	            "a",
	            { className: "waves-effect waves-light btn-large orange accent-4", id: "fccBtn", href: "//www.freecodecamp.com/fractal-mind", target: "_blank" },
	            "freecodecamp"
	          ),
	          _react2.default.createElement(
	            "a",
	            { className: "waves-effect waves-light btn-large orange accent-4", id: "liBtn", href: "//www.linkedin.com/in/will-moody-70423b29", target: "_blank" },
	            "linkedin"
	          )
	        )
	      );
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.list.map(function (skill) {
	          return _react2.default.createElement(_Skillcard2.default, { icon: skill.icon, name: skill.name, info: skill.info, soft: _this2.props.soft });
	        })
	      );
	    }
	  }]);
